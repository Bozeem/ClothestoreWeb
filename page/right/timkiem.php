<?php
	...
	$sql_pro = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND tbl_sanpham.soluong > '0' AND tbl_sanpham.tensanpham LIKE '%".$tukhoa."%'";
...
?>
 ...
 if(!empty($orderField) && !empty($orderSort)){
	...
	$sql_pro = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc AND tbl_sanpham.soluong > '0' AND tbl_sanpham.tensanpham LIKE '%".$tukhoa."%'.".$orderCondition."  ";
	$query_pro = mysqli_query($mysqli,$sql_pro);
}
