...
<li><a href="chitiet.php?quanly=lienhe">Liên Hệ <i class="fas fa-headset "></i></a></li>
  <li ><a href="https://www.facebook.com/profile.php?id=100088585729080">  <i style="color: blue;" class="fab fa-facebook fa-lg"></i></a></li>
  <li ><a href="">  <i style="color: cyan;" class="fab fa-twitter fa-lg"></i></a></li> 
...
<ul>
     <form action="indexs.php?quanly=timkiem" method="POST">
            <input style="margin-left: 29%; width:532px;height:39px;border-radius :5px;    border: solid 2px black; outline:none;padding:10px;" type="text" name="tukhoa" placeholder="Tìm kiếm..">
            <button style="height: 40px;margin: -21px; border: none; border-radius:4px;color:white; background: black;outline:none;width:40px;" name="timkiem" type="submit"><i class="fa fa-search"></i></button>
            </form>        
</ul>
</div>
